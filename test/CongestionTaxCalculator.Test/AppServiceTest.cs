    ...
    public class AppServiceTest : IDisposable
    {
        ...
        public void Test_Read_CompleteTariffDefination_Return_Model_TariffDefination(Persistence.TariffDefinition input, Model.TariffDefinition expected)
        {
            ...
            var request = Fixture.Build<CongestionTaxRequestDto>()
                .With(x => x.CityName, input.City.Name)
                .With(x=>x.TariffNO, input.TariffNO )
                .With(x => x.StartTariffYear, input.StartTariffYear)
                .Create();
        ...
        new List<object[]> {
                // Request1 = Test ExemptVehicle
                 ...
                 // // Request2 = Test PublicHoliday & Before PublicHoliday
                 new object[] {
                     new CongestionTaxRequestDto()
                     {
                         CityName="Gothenburg",
                         ...
                         TrafficTimeSequence = new List<DateTime>()
                         {
                                DateTime.ParseExact("2013-02-06 06:23:27", "yyyy-MM-dd HH:mm:ss", provider),
                                DateTime.ParseExact("2013-02-06 15:23:27", "yyyy-MM-dd HH:mm:ss", provider),
                     ...
                     new Model.TariffDefinition(
                                                    ...
                                                    tariffSetting:new Model.TariffSetting(
                                                            ...
                                                            publicHolidays: new Model.PublicHoliday[] {
                                                                ...
                                                                new Model.PublicHoliday( dateHoliday : new DateTime(2013, 2, 7) ),
                                                                new Model.PublicHoliday( dateHoliday : new DateTime(2013, 4, 10) ),
                                                                new Model.PublicHoliday( dateHoliday : new DateTime(2013, 5, 10) ),
                                                            },
                                                            weekendDays: new DayOfWeek[] {
        ...
        public static IEnumerable<object[]> OtherRequest =>
        new List<object[]> {
                // Request1 = Test ExemptVehicle
                 new object[] {
                    //input                     
                     new CongestionTaxRequestDto()
                     {
                         ...
                         {
                                DateTime.ParseExact("2013-01-14 06:00:00", "yyyy-MM-dd HH:mm:ss", provider),
                                DateTime.ParseExact("2013-01-14 08:10:00", "yyyy-MM-dd HH:mm:ss", provider),
                         }
                     },
                     new Model.TariffDefinition(
                                                    tariffNO:1,
        ...
        [Theory]
        [MemberData(nameof(OtherRequest))]
        public void Test_GetTax_ValidRequest_InCompleteTariffDefination_Rturn_Fee(CongestionTaxRequestDto inputRequest, Model.TariffDefinition inputTariffDefinition, Decimal expected)
        {
            //Arrange
            ICongestionTaxAppService congestionTaxAppService = new CongestionTaxAppService(inputTariffDefinition);
